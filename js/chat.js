	...
	function (t, e, n) {
		...
		function b(t, e, n, r, o) {
			...
			if (((null != e && "boolean" != typeof e) || (e = ""), "string" == typeof e || "number" == typeof e))
				return t && void 0 !== t.splitText && t.parentNode && (!t._component || o) ? t.nodeValue != e && (t.nodeValue = e) : ((i = document.createTextNode(e)), t && (t.parentNode && t.parentNode.replaceChild(i, t), _(t, !0))), (i.__preactattr_ = !0), i;
			var s = e.nodeName;
			...
			return (
				!I && f && 1 === f.length && "string" == typeof f[0] && null != c && void 0 !== c.splitText && null == c.nextSibling ? c.nodeValue != f[0] && (c.nodeValue = f[0]) : ((f && f.length) || null != c) && g(i, f, n, r, I || null != p.dangerouslySetInnerHTML),
				w(i, e.attributes, p),
				(q = a),
				i
			);
		...
		function M(t, e, n, r) {
			if (!t._disable) {
				var o,
					...
					w = !1;
				if (
					(m && ((t.props = f), (t.state = d), (t.context = h), 2 !== e && t.shouldComponentUpdate && !1 === t.shouldComponentUpdate(c, u, l) ? (w = !0) : t.componentWillUpdate && t.componentWillUpdate(c, u, l), (t.props = c), (t.state = u), (t.context = l)),
			...
			function e(n) {
				...
				return (
					...
					(r.handleSendClick = function () {
						r.input.value.replace(/\s/g, "") && (r.say(r.input.value), (r.input.value = ""));
					}),
				...
				(e.prototype.render = function (t, e) {
					...
					return Object(r.b)(
						...
						Object(r.b)(
							"div",
							{ id: "messageArea" },
							config_titulo_mensaje(e.messages),
							Object(r.b)(o.a, {
								messages: e.messages,
...
function config_titulo_mensaje(mensajes) {
	var titleanterior = "";
	setTimeout(() => {
		mensajes.forEach(function (mensaje, index) {
			var titlemessage = mensaje.from == "visitor" ? "Tú" : "19D";
			var indicador = mensaje.from == "visitor" ? "V" : "L";
			var clase = mensaje.from == "visitor" ? "titleVisitor" : "titleChatbot";
			var id = mensaje.id;

			if (titleanterior != titlemessage) {
				if ($("li[data-message-id=" + id + indicador + "]").length == 0) {
					$("li[data-message-id=" + id + "]").before(
						`<li data-message-id="` +
							id +
							indicador +
							`" class="` +
			...
			titleanterior = titlemessage;
			if (mensajes.length - 1 == index) {
