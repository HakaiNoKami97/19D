!(function (t) {
	...
	function (t, e, n) {
		...
		function g(t, e, n, o, r) {
			...
			if (((null != e && "boolean" != typeof e) || (e = ""), "string" == typeof e || "number" == typeof e))
				return t && void 0 !== t.splitText && t.parentNode && (!t._component || r) ? t.nodeValue != e && (t.nodeValue = e) : ((i = document.createTextNode(e)), t && (t.parentNode && t.parentNode.replaceChild(i, t), w(t, !0))), (i.__preactattr_ = !0), i;
			var s = e.nodeName;
			...
			return (
				!z && l && 1 === l.length && "string" == typeof l[0] && null != c && void 0 !== c.splitText && null == c.nextSibling ? c.nodeValue != l[0] && (c.nodeValue = l[0]) : ((l && l.length) || null != c) && y(i, l, n, o, z || null != p.dangerouslySetInnerHTML),
				_(i, e.attributes, p),
				(H = a),
				i
			);
		...
		function S(t, e, n, o) {
			if (!t._disable) {
				var r,
					...
					_ = !1;
				if (
					(m && ((t.props = l), (t.state = d), (t.context = h), 2 !== e && t.shouldComponentUpdate && !1 === t.shouldComponentUpdate(c, u, f) ? (_ = !0) : t.componentWillUpdate && t.componentWillUpdate(c, u, f), (t.props = c), (t.state = u), (t.context = f)),
	...
	function (t, e, n) {
		...
		function r() {
			...
			$("#botmanWidgetRoot").children().addClass("transicion-chat");
		}
				...
				return (
					(e.toggle = function () {
						...
						e.state.isChatOpen ||
							...
							(t.wasChatOpened = !0));
						if (t.isChatOpen) {
							$("#avatar").addClass("avatar-oculto");
							setTimeout(() => {
								e.setState(t);
								if (e.state.isChatOpen) {
									setTimeout(() => {
										$("#botmanWidgetRoot").children().addClass("height-chat");
									}, 10);
								}
							}, 200);
						} else {
							setTimeout(() => {
								$("#botmanWidgetRoot").children().removeClass("height-chat");
							}, 10);
							setTimeout(() => {
								e.setState(t);
								setTimeout(() => {
									$("#avatar").removeClass("avatar-oculto");
								}, 200);
							}, 700);
						}
					}),
